...
func_mat.tri <- function(png, abund){ #png.file, número de indivíduos presente 
  ...
  mat_tri <- try(area_simulada(matriz = binario.focal, N = individuos)) #aplicando area_simulada
