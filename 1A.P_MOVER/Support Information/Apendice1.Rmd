...
## references
# df_references %>% names
df_references <- read.csv(file="/home/danilo/Documentos/artigo_mestrado/1A.P_MOVER/dados_para_iniciar_artigo/references - TreeCo.csv",
