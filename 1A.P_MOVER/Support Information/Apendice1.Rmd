...
```{r}
X[,"txt.name"]
paisagem <- as.matrix(read.table(X[,"txt.name"],header = TRUE,sep = " ",as.is = FALSE))
image
```
...
f_simulacao <- function(i,df_=df_simulacao){
  ...
  path.file <- paste0("/home/danilo/Documentos/Doutorado/artigo_mestrado/1A.P_MOVER/simulacao_codigos_e_resultados/SADs_preditas/",
                      X[,"SiteCode"],
                      "_k",X[,"k"],
                      "_EE.csv")
