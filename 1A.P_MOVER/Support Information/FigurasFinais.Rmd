...
```
```{r}
df_resultados$factor_cong %>% levels
```


```{r, warning=F,message=F}
df_resultados$factor_cong <- NA
df_resultados[which(df_resultados$n_nRef>50 & abs(df_resultados$diffS_mean)<0.25),"factor_cong"] <- "good fit"
df_resultados[-which(df_resultados$n_nRef>50 & abs(df_resultados$diffS_mean)<0.25),"factor_cong"] <- "false positive"
df_resultados[which(df_resultados$diffS_mean>0.25 & df_resultados$factor_cong == "false positive"),"factor_cong"] <- "overestimate S"
df_resultados[which(df_resultados$diffS_mean<0.25 & df_resultados$factor_cong == "false positive"),"factor_cong"] <- "underestimate S"
