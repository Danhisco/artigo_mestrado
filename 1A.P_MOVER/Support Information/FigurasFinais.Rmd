...
df_resultados[which(df_resultados$diffS_mean>0.25),"factor_cong"] <- "overestimate S"
df_resultados[which(df_resultados$diffS_mean<0.25),"factor_cong"] <- "underestimate S"
