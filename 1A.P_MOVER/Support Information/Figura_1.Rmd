...
l_p[[1]] <- ggdraw() + draw_label("Prob. not refuting a predicted SAD")
a_prob_of_not_refuting <- plot_grid(a_SENM,b_SINM,ncol=2)
a_prob_of_not_refuting <- plot_grid(l_p[[1]],a_prob_of_not_refuting,v_legend,ncol=1,rel_heights = c(0.1,1,0.1))
