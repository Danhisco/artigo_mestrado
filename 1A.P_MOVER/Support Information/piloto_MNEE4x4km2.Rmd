---
title: "Exist diferença nas predições de MNEE em paisagens de 10x10km e de 4x4km?"
...
Anteriormente eu havia rodado as simulações dos modelos neutros considerando paisagens de 10.2 x 10.2 km2, porém o sugerido pela análise de escala de efeito é 4.07 x 4.07 km2 (Fig. 1). Será que as predições do modelo espacialmente explicito são robustas à redução da extensão espacial da paisagem?
...
registerDoMC(3)
l_md <- dlply(df_escalaEfeito,"raio_km",f_glm.nb,.parallel = TRUE)
