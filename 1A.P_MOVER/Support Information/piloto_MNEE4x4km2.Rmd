...
__ Sorteio de sítios ao longo do gradiente de cobertura vegetal nas paisagens de 10x10km2 __  

```{r dados,message=FALSE,echo=FALSE}
### dados ###
# leitura
...
```{r estatisticas descritivas da variacao em p entre escalas,echo=FALSE,include=FALSE}
