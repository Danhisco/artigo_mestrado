...
l_p[[1]] <- df_U %>% 
  ...
  geom_point(alpha=0.3) + labs(x="log10(Sobs)",y="log10(U)",title="log10(U) = N(-4.175,0.05838) + 0.972*log10(Sobs)")
l_p[[2]] <- df_U %>% 
  ...
  geom_point(alpha=0.3) + labs(x="Sobs",y="U",title="U = [10 ^ N(-4.175,0.05838)] * Sobs ^ 0.972")
...
f_md <- function(model_class){
  ...
  if(model_class == "tp"){
    ...
    md_ <- gam(log10_U ~ log10_Sobs +
                 ...
                 s(SiteCode,bs="re") + s(d.z,by=SiteCode,bs="cc",m=1,k=10),
                data = df_U, family=gaussian,method = "REML")
  }else if(model_class == "ps"){
    md_ <- gam(log10_U ~ log10_Sobs +
                 s(d.z,bs="ps",k=10) + s(p.z,bs="ps",k=10) + ti(d.z,p.z,bs=c("ps","ps"),k=c(10,10)) +
                 s(SiteCode,bs="re") + s(d.z,by=SiteCode,bs="ps",m=1,k=10),
                data = df_U, family=gaussian,method = "REML")
  }else{
      md_ <- gam(log10_U ~ log10_Sobs +
                 s(d.z,bs="gp",k=10) + s(p.z,bs="gp",k=10) + ti(d.z,p.z,bs=c("gp","gp"),k=c(10,10)) +
                 s(SiteCode,bs="re") + s(d.z,by=SiteCode,bs="gp",m=1,k=10),
                data = df_U, family=gaussian,method = "REML")
  }
  return(md_)
}
# registerDoMC(2)
l_md.U_gamEstudo <- dlply(df_md.class,"md_class",f_md)
```

Se paralelizar acusa um aviso:
Warning message:
...
E todos os itens da lista voltam em branco

Mesmo sem paralelizar quando tudo acaba o Rstudio quebra usando o dlply


```{r}
l_md <- list()
l_md[[1]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="tp",k=10) + s(p.z,bs="tp",k=10) + ti(d.z,p.z,bs=c("tp","tp"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",k=10,xt = list("tp")),
                data = df_U, family=gaussian,method = "REML")
l_md[[2]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="cr",k=10) + s(p.z,bs="cr",k=10) + ti(d.z,p.z,bs=c("cr","cr"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",k=10,xt = list("cr")),
                data = df_U, family=gaussian,method = "REML")
l_md[[3]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="cc",k=10) + s(p.z,bs="cc",k=10) + ti(d.z,p.z,bs=c("cc","cc"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",k=10,xt = list("cc")),
                data = df_U, family=gaussian,method = "REML")
l_md[[4]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="ps",k=10) + s(p.z,bs="ps",k=10) + ti(d.z,p.z,bs=c("ps","ps"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",k=10,xt = list("ps")),
                data = df_U, family=gaussian,method = "REML")
l_md[[5]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="gp",k=10) + s(p.z,bs="gp",k=10) + ti(d.z,p.z,bs=c("gp","gp"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",k=10,xt = list("gp")),
                data = df_U, family=gaussian,method = "REML")
# l_md[[6]] <- gam(log10_U ~ offset(log10_Sobs) +
#                  s(d.z,bs="ts",k=10) + s(p.z,bs="ts",k=10) + ti(d.z,p.z,bs=c("ts","ts"),k=c(10,10)) +
#                  s(d.z,SiteCode,bs="fs",k=10,xt = list("ts")),
#                 data = df_U, family=gaussian,method = "REML")
# l_md[[7]] <- gam(log10_U ~ offset(log10_Sobs) +
#                  s(d.z,bs="cs",k=10) + s(p.z,bs="cs",k=10) + ti(d.z,p.z,bs=c("cs","cs"),k=c(10,10)) +
#                  s(d.z,SiteCode,bs="fs",k=10,xt = list("cs")),
#                 data = df_U, family=gaussian,method = "REML")
names(l_md) <- c("tp","cr","cc","ps","gp")
AICctab(l_md,weights=TRUE)
# df_U %>% ggplot(aes(y=log10_U,x=log10(d))) + geom_point()
```
...
load("~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md_log10.U_gamEstudo.Rdata")
df_U %>% names
```
...
l_md[[2]] <- gam(log10_U ~ offset(log10_Sobs) +
                ...
                data = df_U, family=gaussian,method = "REML")
l_md[[3]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(log10_d.z,bs="cc",k=10) + s(p.z,bs="cc",k=10) + ti(log10_d.z,p.z,bs=c("cc","cc"),k=c(10,10)) +
                 s(log10_d.z,SiteCode,bs="fs",k=10,xt = list("cc")),
                data = df_U, family=gaussian,method = "REML")
l_md[[4]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(log10_d.z,bs="ps",k=10) + s(p.z,bs="ps",k=10) + ti(log10_d.z,p.z,bs=c("ps","ps"),k=c(10,10)) +
                 s(log10_d.z,SiteCode,bs="fs",k=10,xt = list("ps")),
                data = df_U, family=gaussian,method = "REML")
l_md[[5]] <- gam(log10_U ~ offset(log10_Sobs) +
                 s(log10_d.z,bs="gp",k=10) + s(p.z,bs="gp",k=10) + ti(log10_d.z,p.z,bs=c("gp","gp"),k=c(10,10)) +
                 s(log10_d.z,SiteCode,bs="fs",k=10,xt = list("gp")),
                data = df_U, family=gaussian,method = "REML")
# l_md[[6]] <- gam(log10_U ~ offset(log10_Sobs) +
#                  s(d.z,bs="ts",k=10) + s(p.z,bs="ts",k=10) + ti(d.z,p.z,bs=c("ts","ts"),k=c(10,10)) +
#                  s(d.z,SiteCode,bs="fs",k=10,xt = list("ts")),
...
```{r}
save(l_md.U_mdCheio,file="~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md.U_mdCheio_semSobs_tp.Rdata")
```

```{r}
load("~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md.U_mdCheio_semSobs.Rdata")
AICctab(l_md.U_mdCheio,weights=T)
md_U <- l_md.U_mdCheio[["gamm d|Site for each"]]

appraise(md_U)
teste <- predict.gam(md_U,se.fit = TRUE)

lapply(lapply(teste,exp),summary)

gam.check(md_U)
```


__comparação com e sem Sobs___

```{r}
## com Sobs
load("~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md_log10.U_gamEstudo.Rdata")
md_U <- l_md_log10.U_gamEstudo[["cr"]]
# save(md_U_sSobs,file = "~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/md_U_sSobs.Rdata")
## sem Sobs
md_U_offset.Sobs <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="cr",k=10,m=1) + s(p.z,bs="cr",k=10,m=1) + ti(d.z,p.z,bs=c("cr","cr"),k=c(10,10),m=1) +
                 s(SiteCode,bs="re") + s(d.z,by=SiteCode,bs="cr",m=1,k=10),
                data = df_U, family=gaussian,method = "REML")
save(md_U_offset.Sobs,file = "~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/md_U_offset.Sobs.Rdata")
## smoother por sitio compartilhando a mesma penalização de ajuste
md_U_GS <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="cr",k=10,m=1) + s(p.z,bs="cr",k=10,m=1) + ti(d.z,p.z,bs=c("cr","cr"),k=c(10,10),m=1) +
                 s(d.z,SiteCode,bs="fs",m=1,k=10,xt = list("cr")),
                data = df_U, family=gaussian,method = "REML")
md_U_GS_logSobs <- gam(log10_U ~ log10_Sobs +
                 s(d.z,bs="cr",k=10,m=1) + s(p.z,bs="cr",k=10,m=1) + ti(d.z,p.z,bs=c("cr","cr"),k=c(10,10),m=1) +
                 s(d.z,SiteCode,bs="fs",m=1,k=10,xt = list("cr")),
                data = df_U, family=gaussian,method = "REML")
save(md_U_GS_k15,file = "~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/md_U_GS_k15.Rdata")
load("~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/md_U_GS_k15.Rdata")
## smoother e penalização de ajuste por sítio: 
# md_U_te <- gam(log10_U ~ offset(log10_Sobs) +
#                           te(d.z,p.z,bs=c("cr","cr"),k=c(10,10),m=2) +
#                           t2(d.z,p.z,SiteCode,bs=c("cr","cr","re"),k=c(10,10),m=1,full = TRUE),
#                 data = df_U, family=gaussian,method = "REML")
gratia::appraise(md_U_GS_k15)
###### tp
md_U_GS_tp <- gam(log10_U ~ offset(log10_Sobs) +
                 s(d.z,bs="tp",k=10,m=1) + s(p.z,bs="tp",k=10,m=1) + ti(d.z,p.z,bs=c("tp","tp"),k=c(10,10),m=1) +
                 s(d.z,SiteCode,bs="fs",m=1,k=10,xt = list("tp")),
                data = df_U, family=gaussian,method = "REML")
save(md_U_GS_tp,file = "~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/md_U_GS_tp.Rdata")
AICctab(md_U_GS_tp,md_U_GS,weights=T)
gratia::appraise(md_U_GS_tp)
summary(md_U_offset.Sobs)
gratia::appraise(md_U)
```

Não observo diferença nos gráficos diagnosticos, e na tabela de AIC os modelos estão empatados com uma pequena vantagem para o sem Sobs

O modelo com offset apresenta o mesmo problema da matriz de covariância não ser positivamente definido

vou mudar o modelo para ter um smoother por sítio compartilhando o mesmo penalizador de fit

o modelo mais simples está dentro dos critérios para fazer o predito a posteriori

O modelo final é mais plausível do que mantem o offset para log10(Sobs) com k=15; e sem offset para log10(Sobs), com o parametro estimado 

Eu comparei este novo modelo com as

```{r eval=FALSE}
# dados
## sem Sobs
load(file="~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md.U_mdCheio_semSobs.Rdata")
l_md.U_semSobs <- l_md.U_mdCheio
# l_md.U_semSobs %>% length()
## com Sobs
load(file="~/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md.U_mdCheio.Rdata")
l_md.U_comSobs <- l_md.U_mdCheio
# l_md.U_comSobs %>% length()

## cr sem Sobs penalização comum 
# load(file="/home/danilo/Documentos/artigo_mestrado/1A.P_MOVER/Support Information/l_md_U_gammCheio.Rdata")
# md_U.cr <- l_md_U_gammCheio[[8]]

## AICctab
# AICctab(l_md.U_semSobs,weights=T)
md_U_semSobs<- l_md.U_semSobs[["gamm d|Site common"]]
# AICctab(l_md.U_comSobs,weights=T)
md_U_comSobs<- l_md.U_comSobs[["gamm d|Site common"]]

## graf diag
gratia::appraise(md_U_semSobs)
gratia::appraise(md_U_comSobs)
# gratia::appraise(md_U.cr)


## summary
summary(md_U_semSobs)
summary(md_U_comSobs)
# summary(md_U.cr)


## melhor modelo
AICctab(md_U_semSobs,md_U_comSobs,weights=TRUE) #,md_U.cr
```
...
l_p[[1]] <- ggplot(df_, aes(x=p.z,y=residuals)) +
  geom_smooth(method="loess") +
  geom_point(alpha=0.3)
l_p[[2]] <- ggplot(df_, aes(x=d.z,y=residuals)) +
  geom_smooth(method="loess") +
  geom_point(alpha=0.3)
l_p[[3]] <- ggplot(df_, aes(x=log10_U,y=fit)) +
  geom_smooth(method="loess") +
  geom_point(alpha=0.3)
grid.arrange(grobs=l_p,ncol=3) #,top="deviance residual ~ continuous predictors"
```
...
df_plot %>% ggplot(aes(x=d.z,y=log10_U)) +
  ...
  facet_wrap(~title,ncol=5,scales="free")
```
O modelo estava fazendo um bom ajuste, apesar na fase logito parece existir um problema de overfit que me parece relacionado com a função base

### observado e predito por sítio de amostragem

```{r}
Cv[1:10,1:10]
matrix(nus, nrow = length(beta), ncol = num_beta_vecs) %>% dim
gam.check(md_U_GS)
```
...
df_ <- cbind(fit = gamm$fitted.values,
             gamm$model)
beta <- coef(gamm)
V <- vcov.gam(gamm)
