...
__Figura 2.2.1__ Appraise(md_nRefEE)
...
AICctab(l_nRefEE_mdCheio__sOut)
```
...
```{r fig 225 predito e observado por sitio md_nRefEE, echo=FALSE,eval=TRUE, fig.width=8, fig.height=30,message=FALSE}
# dados
df_plot <- df_md
...
__Figura 2.2.6__ Diagnostico: avaliação do ajuste pelas preditoras lineares

```{r fig 226,echo=FALSE,eval=TRUE,fig.height=5}
#
