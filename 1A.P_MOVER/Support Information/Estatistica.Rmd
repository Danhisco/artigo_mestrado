...
f_md <- function(model_class){
  model_class <- unique(model_class$md_class)
  if(model_class == "tp"){
    md_ <- lm(U_med ~ 1,df_md)
  }else if(model_class == "ds"){
    md_ <- lm(U_med ~ 1,df_md)
  }else if(model_class == "cr"){
    md_ <- lm(U_med ~ 1,df_md)
  }else if(model_class == "cc"){
...
l_md[[1]] <- gam(U_med ~ 
                ...
                data = df_md, Gamma(link = "log"))
l_md[[2]] <- gam(U_med ~ 
                 s(d.z,bs="ds",k=10) + s(p.z,bs="ds",k=10) + ti(d.z,p.z,bs=c("ds","ds"),,k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",xt=list(bs="ds"), m=1),
                data = df_md, Gamma(link = "log"))
l_md[[3]] <- gam(U_med ~ 
                 s(d.z,bs="cr",k=10) + s(p.z,bs="cr",k=10) + ti(d.z,p.z,bs=c("cr","cr"),k=c(10,10)) +
                 s(d.z,SiteCode,bs="fs",xt=list(bs="cr"), m=1,k=10),
...
l_md[[6]] <- gam(U_med ~ 
                 ...
                 s(d.z,SiteCode,bs="fs",xt=list(bs="gp"), m=1,k=10),
                data = df_md, Gamma(link = "log"))
names(l_md) <- c("tp","ds","cr","cc","ps","gp")
AICctab(l_md)
