...
# n_nRef - número de SADs não refutadas de uma simulação neutra
...
names(l_md) <- c("l k0 1|Site","l k0 MN|Site","l k0 k0*MN|Site",
                 ...
                 #d/L_plot
                 "l d/L_plot 1|Site","l d/L_plot MN|Site","l d/L_plot d/L_plot*MN|Site",
                 "p d/L_plot 1|Site","p d/L_plot MN|Site","p d/L_plot d/L_plot*MN|Site",
                 "c d/L_plot 1|Site","c d/L_plot MN|Site","c d/L_plot d/L_plot*MN|Site")
## logito ##
...
l_md[[5]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k * MN + (MN|SiteCode),
                   ...
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## probit ##
l_md[[6]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[7]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (MN|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[8]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[9]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[10]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k * MN + (MN|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## cloglog
l_md[[11]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[12]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (MN|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[13]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
...
l_md[[13]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   ...
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)),
                   start = par_md)
l_md[[14]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[15]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * k * MN + (MN|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
### d / L_plot
## logito ##
l_md[[16]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (1|SiteCode),
                   family = "binomial",data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[17]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN|SiteCode),
                   family = "binomial",data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[18]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial",data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## probit ##
l_md[[19]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[20]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
######################################
####### problema de ajuste #######
######################################
l_md[[21]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
par_md <- getME(l_md[[21]],c("theta","fixef"))
l_md[[21]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)),
                   start = par_md)
...
######################################
## cloglog
l_md[[22]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[23]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
######################################
####### com problema de ajuste #######
######################################
l_md[[24]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)))
par_md <- getME(l_md[[24]],c("theta","fixef"))
l_md[[24]] <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)),
                   start = par_md)
...
######################################
names(l_md)
# # oitavo modelo com problema:
l_md1 <- l_md
l_md <- l_md1[c(1:7,9:12,14:20,22:23)]
AICctab(l_md,weights=T)
```

Para a variável d/Lplot o modelo com estrutura aleatoria completa não rodou para link=c(probit,cloglog), apesar das modificações nos modelos.
...
Excluindo os modelos que não rodaram, o único modelo plausível é aquele com função de ligação logito, a variável d/L_plot e a estrutura aleatória MN * d/L_plot|SiteCode. Segue avaliação do pressuposto binomial(link=cloglog):

```{r auditoria mais plausivel md_n.ref1}
# md_n.ref <- l_md[[23]]
md_n_nRef <- glmer(cbind(n_nRef,100-n_nRef) ~ p.z * d_Lplot.z * MN + (MN*d_Lplot.z|SiteCode),
                   family = "binomial",data=df_resultados,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)))
p_plot <- DHARMa::simulateResiduals(md_n_nRef,n=1000)
plot(p_plot)
```

__Figura 1__ Resíduos Quantílicos do único modelo plausível para n_nRef ~ p * I(d/L_plot)*MN + (I(d/L_plot)|SiteCode)
...
l_p <- vector("list",4)
l_p[[1]] <- plot(md_n_nRef, sqrt(abs(resid(.)))~fitted(.),
                 type=c("p","smooth"),ylab=expression(sqrt(abs(resid))))
l_p[[2]] <- plot(md_n_nRef,resid(.,type="pearson")~p.z,
      type=c("p","smooth"),
      id=0.05,idLabels=~SiteCode)
l_p[[3]] <- plot(md_n_nRef,resid(.,type="pearson")~d_L.plot.z,
      type=c("p","smooth"),
      id=0.05,idLabels=~SiteCode)
l_p[[4]] <- plot(md_n_nRef,MN~resid(.,type="pearson"),
      type=c("p","smooth"),
      id=0.05,idLabels=~SiteCode)
do.call("grid.arrange",c(l_p,ncol=2))
```

__Figura 2__ Resíduos "Pearson" do único modelo plausível para n_ref ~ p * I(d/L_plot)*MN + (I(d/L_plot)|SiteCode)
...
# prepração dos dados
df_md_n_nRef <- augment(md_n_nRef)
df_md_n_nRef$.pearson_resid <- resid(md_n_nRef,type="pearson")
Sites <- df_md_n_nRef %>% 
...
names(l_md) <- c("l k0 1|Site","l k0 MN|Site","l k0 k0*MN|Site",
                 ...
                 "c d/L_plot 1|Site","c d/L_plot MN|Site","c d/L_plot d/L_plot*MN|Site")
## logito ##
l_md[[1]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (1|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[2]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[3]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[4]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (1|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[5]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## probit ##
l_md[[6]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[7]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[8]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[9]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[10]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## cloglog
l_md[[11]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[12]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[13]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)))
par_md <- getME(l_md[[13]],c("theta","fixef"))
l_md[[13]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k_1.z * MN + (MN*k_1.z|SiteCode),
                   ...
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)),
                   start = par_md)
l_md[[14]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[15]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * k * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
### d / L_plot
## logito ##
l_md[[16]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (1|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[17]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[18]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial",data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## probit ##
l_md[[19]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (1|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[20]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[21]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = probit),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
## cloglog
l_md[[22]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (1|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[23]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[24]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)))
# names(l_md)
# oitavo modelo com problema:
l_md1 <- l_md
l_md <- l_md1[c(1:7,9:24)]
AICctab(l_md,weights=T)
```
...
md_n.ref_sOut <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode),
                   family = "binomial"(link = cloglog),data=df_resultados.s_out,
                   control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e7)))
p_plot <- DHARMa::simulateResiduals(md_n.ref_sOut,n=1000)
plot(p_plot)
```

O pressuposto de binomial(link=cloglog) continua não sendo adequado.

O modelo cheio pode não estar adequado para a seleção das variáveis (pressuposto binomial(link=cloglog) pode não ser adequado), porém vou avaliar o modelo pela comparação entre predito e observado. Assim sigo com a seleção das variáveis. Pela comparação das estruturas aleatórias concluo que manter a maior flexibilidade possível é o mais adequado. A estrutura aleatória completa é (MN * d_L.plot.z | SiteCode) para o modelo cheio que possui a interação MN*d_Lplot.z, para os demais modelos que não apresentam esse termo a estrutura aleatória segue a relação de MN e d_Lplot.z. 

```{r n_ref selecao de modelos}
l_md <- vector("list",19)
names(l_md) <- c("p*d*MN",# modelo cheio
                 ...
                 "1") #nulo
#modelo cheio
l_md[[1]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#modelo cheio - interação 3a ordem
l_md[[2]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z * MN - p.z:d_L.plot.z:MN + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#2 interações
l_md[[3]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * (d_L.plot.z + MN) + (MN+d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[4]] <- glmer(cbind(n_Ref,100-n_Ref) ~ d_L.plot.z * (p.z + MN) + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[5]] <- glmer(cbind(n_Ref,100-n_Ref) ~ MN * (p.z + d_L.plot.z) + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#1 interação + preditor
l_md[[6]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z + MN + (MN+d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[7]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * MN + d_L.plot.z + (MN+d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[8]] <- glmer(cbind(n_Ref,100-n_Ref) ~ d_L.plot.z * MN + p.z + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#1 interação
l_md[[9]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * d_L.plot.z + (d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[10]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z * MN + (MN|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[11]] <- glmer(cbind(n_Ref,100-n_Ref) ~ d_L.plot.z * MN + (MN*d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#aditivo 3
l_md[[12]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z + d_L.plot.z + MN + (MN+d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#aditivo 2
l_md[[13]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z + d_L.plot.z + (d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[14]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z + MN + (MN|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[15]] <- glmer(cbind(n_Ref,100-n_Ref) ~ d_L.plot.z + MN + (MN+d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
#aditivo 1
l_md[[16]] <- glmer(cbind(n_Ref,100-n_Ref) ~ p.z + (1|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[17]] <- glmer(cbind(n_Ref,100-n_Ref) ~ d_L.plot.z + (d_L.plot.z|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
l_md[[18]] <- glmer(cbind(n_Ref,100-n_Ref) ~ MN + (MN|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
# nulo
l_md[[19]] <- glmer(cbind(n_Ref,100-n_Ref) ~ 1 + (1|SiteCode), family = "binomial",data=df_resultados,
              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=100000)))
AICctab(l_md,weights=T)
```
...
Como visto anteriormente ele não apresenta boa congruência com o observado. Generalized Additive Models (GAM) apresentam maior flexibilidade e vou utiliza-los para modelar o padrão não linear observado.
...
ctrl <- 3
l_md <- vector("list",3)
names(l_md) <- c("1|SiteCode",)
l_md[[1]] <- gam(cbind(n_nRef,100-n_nRef) ~ s(p.z,by=MN,bs="tp") + s(d_Lplot.z,by=MN,bs="tp") + ti(p.z,d_Lplot.z,by=MN,bs="tp") +
                   s(SiteCode,bs="re"),
                 family = "binomial",
