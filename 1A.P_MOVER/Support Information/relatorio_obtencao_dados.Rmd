...
```{r auditoria 1 janela de codigo 3,eval=TRUE,echo=FALSE,fig.width=8,fig.height=40,fig.align='center',cache=TRUE}
# df_ da pasta
...
```{r conserto e descarte de rasters, eval=FALSE,echo=TRUE}
v_Sites__conserto <- c("MGuberl7","BAlenc4","MGlavr6","SCarar","SPcamp1")
...
# exemplo: o ponto de inicío é [4,4] e o ponto l_,c_ é [3,3], portanto em termos de l_,c_:
p_inicio <- c(l_,c_)
...
```{r figura 2 sitios consertados,eval=TRUE,echo=FALSE,fig.align='center',fig.height=2,cache=TRUE}
v_Sites__conserto <- c("MGuberl7","BAlenc4","MGlavr6","SCarar","SPcamp1")
df_auditoria2 <- df_auditoria %>% filter(SiteCode %in% v_Sites__conserto)
par(mfrow=c(1,5))
