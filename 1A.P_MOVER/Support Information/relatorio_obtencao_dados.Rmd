...
#### Prop. de cobertura vegetal para diferentes raios da paisagem local
...
```{r codigo para determinar p para cada raio da paisagem local,echo=TRUE}
# dados
