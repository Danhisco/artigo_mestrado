...
# Q <- 1/.J_M
```
```{r equacao 5 de Hu et al 2007, echo=FALSE,eval=TRUE}
# equação 5
...
```
```{r aplicar eq 5 usando as classes de abundância,echo=TRUE,eval=FALSE,cache=FALSE,error=FALSE}
...
```{r auditoria de EEeEI.csv, echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=4}
# dados
