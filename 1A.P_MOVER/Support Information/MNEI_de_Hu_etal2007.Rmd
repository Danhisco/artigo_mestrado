...
f_simMNEI <- function(i,df_=df_fig3_HUetal2007){
  X <- df_[i,]
  df_r <- f_MNEI_Hu_etal_2007(.J_M = X$J_M,
                              .J = X$J,
                              .U = X$U,
                              .m = X$m)
  return(df_r)
...
registerDoMC(2)
simulacao <- as.list(1:dim(df_fig3_HUetal2007)[1])
teste <- ldply(simulacao,f_simMNEI,.parallel = TRUE)
teste |> head()
