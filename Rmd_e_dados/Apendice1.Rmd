...
registerDoMC(2)
sapply(df_dados.disponiveis$tif.name,func_tif.png,.parallel = TRUE) #gera 113 .png, oriundos dos .tif
...
func_png.ajust <- function(file, densidade, A_landscape=500){ #utilizo o image magick
  system(paste(
