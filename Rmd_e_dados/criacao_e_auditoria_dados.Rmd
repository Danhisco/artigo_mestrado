...
# registerDoMC(4) # tentatida de paralelizar 1 [TESTAR]
...
# teste de Kolmogoro-Smirnov #
  ...
  df_ks.teste[[i]] %<>% dplyr::select(k,p,J,S,DA,d,theta_,m_,I,GOF,GOF_,S_m,S_sd,KS.D_mean,KS.D_sd,KS.p_mean,KS.p_sd)
}
...
df_resultados %<>% select(SiteCode,k,MN,GOF,p,d,m_,I,J,S,DA,S_m,S_sd,KS.D_mean,KS.D_sd,KS.p_mean,KS.p_sd)
