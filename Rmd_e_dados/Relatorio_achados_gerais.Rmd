...
l_md[[1]] <- lmer(lU ~ p.z * k + log_S.z + (1 | Site), data = df_resultados)
l_md[[2]] <- lmer(lU ~ p.z + k + log_S.z + (1 | Site), data = df_resultados)
l_md[[3]] <- lmer(lU ~ p.z + log_S.z + (1 | Site), data = df_resultados)
l_md[[4]] <- lmer(lU ~ k + log_S.z + (1 | Site), data = df_resultados)
l_md[[5]] <- lmer(lU ~ log_S.z + (1 | Site), data = df_resultados)
